...
export async function createUser(email: string, password: string) {
  ...
  try {
    ...
    console.error("[createUser] Attempted values:", { email, passwordLength: hashedPassword?.length });
...
export async function createGuestUser() {
  ...
  try {
    ...
    console.error("[createGuestUser] Attempted values:", { email, passwordLength: password?.length });
    throw new ChatSDKError(
      "bad_request:database",
...
export async function saveChat({
  ...
  try {
    ...
    console.error("[saveChat] Attempted values:", { id, userId, title, visibility });
